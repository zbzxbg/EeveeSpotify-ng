...
<details>
<summary><b>v1.1.0-beta.1</b></summary>

- 优化 歌词多级回退逻辑，Mxm 和 PetitLyrics 最长等待五秒，LRCLIB 和 Genius 最长等待三秒
- 优化 歌词请求拦截，兼容不同版本的 Spotify 歌词请求路径
- 优化 启动和切歌时的当前曲目匹配，减少歌词请求过早失败的问题
- 修复 自定义歌词加载失败时可能重新显示 Spotify 官方歌词的问题
- 修复 日语歌词在本地罗马化时被误判为中文的问题
- 修复 检查更新时当前版本与 GitHub 最新版本相同仍提示可更新的问题
- 优化 ngzhwm 设置界面的英文和简体中文本地化说明
